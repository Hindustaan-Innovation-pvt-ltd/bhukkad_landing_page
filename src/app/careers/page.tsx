  ...
  return (
    <main className="min-h-screen bg-slate-50/30 pt-28 pb-12 font-sans overflow-x-clip">
      ...
      <section className="w-full max-w-[1200px] mx-auto px-6 md:px-12 mb-16 text-center">
        ...
        <h1 className="font-poppins font-black text-[38px] md:text-5xl lg:text-6xl text-slate-900 mb-6 tracking-tight">
          Help Us Build the Future <br className="hidden md:block" />
          of <span className="text-primary">Food Delivery</span>
        </h1>
        <p className="text-slate-600 font-medium text-[16px] md:text-lg leading-relaxed max-w-2xl mx-auto mb-10">
      ...
      <section className="w-full max-w-[1200px] mx-auto px-6 md:px-12 mb-20">
        <h2 className="font-poppins font-black text-3xl text-center text-slate-900 mb-12">Why Work With Us?</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            <div key={idx} className="bg-white p-6 rounded-[24px] shadow-sm border border-slate-100 flex flex-col items-start text-left">
              <div className="w-12 h-12 rounded-xl bg-indigo-50 flex items-center justify-center text-primary mb-4">
                {perk.icon}
              </div>
              <h3 className="font-bold text-slate-900 text-lg mb-2">{perk.title}</h3>
      ...
      <section className="w-full max-w-[1000px] mx-auto px-6 md:px-12">
        <div className="bg-white rounded-[32px] p-8 md:p-12 shadow-sm border border-slate-100">
          <h2 className="font-poppins font-black text-3xl text-slate-900 mb-8">Open Positions</h2>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={idx} className="group p-6 rounded-2xl border border-slate-100 hover:border-primary/30 hover:bg-slate-50/50 transition-all flex flex-col md:flex-row md:items-center justify-between gap-4 cursor-pointer">
                <div>
                  <h3 className="font-bold text-slate-900 text-lg group-hover:text-primary transition-colors mb-1">{job.title}</h3>
                ...
                <div className="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-400 group-hover:bg-primary group-hover:text-white transition-all shrink-0">
          ...
          <div className="mt-10 text-center">
            <p className="text-slate-500 font-medium mb-4">Don't see a role that fits you?</p>
