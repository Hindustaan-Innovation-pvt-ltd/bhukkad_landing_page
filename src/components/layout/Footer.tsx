      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <a href="https://play.google.com/store/apps/details?id=com.bhukkhad" target="_blank" rel="noopener noreferrer" className="bg-[#58cc02] hover:bg-[#46a302] text-white font-semibold py-2.5 px-5 rounded-[12px] flex w-max items-center gap-2 mb-8 transition-colors shadow-lg shadow-[#58cc02]/20">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link href="/support" className="text-gray-400 hover:text-[#66C109] transition-colors text-[13px] md:text-[14px]">Support</Link></li>
            </ul>
          </div>
      ...
      <div className="w-full bg-[#060e08] border-y border-white/5 mt-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="py-8 flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-8 w-full">
            ...
            <a href="https://hindustaan.in/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-0 opacity-70 hover:opacity-100 transition-opacity cursor-pointer">
