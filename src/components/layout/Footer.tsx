        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-3">
              <a
                href="https://www.instagram.com/hindustaan_in?igsi=MXRzMDZpcnB4dWJsaA=="
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.facebook.com/profile.php?id=61590521631778"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full border border-gray-700/50 flex items-center justify-center text-gray-400 hover:text-white hover:border-[#66C109] hover:bg-[#66C109]/10 transition-colors"
              >
              ...
              <a
                href="https://x.com/Hindustaan_in"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full border border-gray-700/50 flex items-center justify-center text-gray-400 hover:text-white hover:border-[#66C109] hover:bg-[#66C109]/10 transition-colors"
              >
              ...
              <a
                href="https://www.linkedin.com/company/hindustaaninnovations"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full border border-gray-700/50 flex items-center justify-center text-gray-400 hover:text-white hover:border-[#66C109] hover:bg-[#66C109]/10 transition-colors"
              >
